...
HomeGame.Contact.prototype = {
	...
	fadeText: function() {
		this.game.add.tween(this.copyText).to( { alpha: 0 }, 1000, Phaser.Easing.Linear.None, true);
	},
    ...
    createPlayer: function() {
    	...
    	if (generalFunctions.previousState === 'experience') {
			...
			widthPop = 90;
    		heightPop = this.game.height * 0.5;
		}

		this.player = this.game.add.sprite(widthPop, heightPop, 'textureAtlas', 'ninja1');
    	
		if (generalFunctions.previousState === 'experience')
    		this.player.scale.x = generalFunctions.leavingExperienceScaleX;
    },
    ...
    playerSetup: function() {
    	if (this.player.x >= 305) {
			...
			setTimeout(this.disableCursorDown.bind(null, this.cursors), 1000);
		}
    },
