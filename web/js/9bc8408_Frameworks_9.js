...
HomeGame.Frameworks.prototype = {
    create: function() {
        ...
        //Adding the table
        skillsFunctions.generateTable(['BootStrap', 'Symfony', 'Phaser.js', 'Silex']);
        ...
        skillsFunctions.generateSigns(this, 'frameworks', 'others', 'languages');
        ...
        generalFunctions.previousState = 'frameworks';
    },
