...
HomeGame.Others.prototype = {
    create: function() {
        ...
        //Adding the table
        skillsMethods.generateTable(['Twig', 'Doctrine', 'Wordpress', 'jQuery', 'Linux']);

        //Initial map setup
        gameMethods.mapSetup(this, 'skillsMap');

        //Create the top of the chests (behind the coins)
        skillsMethods.createTopChests(this, [0, 0, 0]);
        ...
        skillsMethods.generateCoin(this, 'silver', 352);
        skillsMethods.generateCoin(this, 'silver', 300);
        skillsMethods.generateCoin(this, 'bronze', 452);
        ...
        skillsMethods.generateSigns(this, 'others', 'home', 'frameworks');
